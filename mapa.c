...
Vector2 spawnPoints(int i, int width, int height)
{
    ...
    spawnPointMob[2] = (Vector2){48 * 2, height + 48 * 9};       //Spawnpoint esquerda tunel
    spawnPointMob[3] = (Vector2){48 * 25, 520};                  //Spawnpoint porta entre caixões
    spawnPointMob[4] = (Vector2){width * 3 - 48 * 15, 520};      //Spawnpoint ponte
