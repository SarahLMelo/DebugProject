...
void AnimarBala(spritesheet *anim)
{
    ...
    if (aux.ativo == 1)
        DrawTexturePro(aux.textura1, aux.frame, destRec, (Vector2){0.0f, 0.0f}, -aux.angulo, WHITE);
    else
        DrawTexturePro(aux.textura2, aux.frame, destRec, (Vector2){0.0f, 0.0f}, -aux.angulo, WHITE);
    *anim = aux;
}
...
void AnimarPlayer(spritesheet *anim, int acao)
{
    ...
    if (aux.ativo == 1)
        DrawTexturePro(aux.textura1, aux.frame, destRec, (Vector2){0.0f, 0.0f}, (float)0, WHITE);
    else
        DrawTexturePro(aux.textura2, aux.frame, destRec, (Vector2){1.0f, 0.0f}, (float)0, WHITE);
    *anim = aux;
}
        ...
        else
        {
            if (aux.frameCounter >= (60 / aux.frameSpeed))
            {
                ...
                if (cos(aux.angulo) > 0)
                    ...
                    (*frame).y = 1 * (float)(*textura).height / 2;
