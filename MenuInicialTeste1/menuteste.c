...
void menuInicial(){
    ...
    Texture2D botaoStart=LoadTexture("Assets/Menu/start.png");
    Texture2D botaoGlossario=LoadTexture("Assets/Menu/menu.png");

    //carregando o nerdola*
    Texture2D nerdola = LoadTexture("Assets/medieval/Sprites/Idle.png");
    ...
    Texture2D monstro = LoadTexture("Assets/mob/Attack3.png");
    ...
    //InitAudioDevice();
    Sound ratinho = LoadSound("Assets/Som/musicaMenu.wav");
